export default function AboutPage() {
  return (
    <main className="mx-auto w-[min(1100px,calc(100%-32px))] py-20">
      ...
      <section className="mt-8 rounded-3xl border border-white/10 bg-[#101B2E] p-7">
        <h2 className="text-2xl font-bold">Experience</h2>
        <p className="mt-4 leading-8 text-[#9EACC0]">
          DEPi — Software Testing Internship<br />
          Genesis Creation — Game Development Internship
        </p>
      </section>
    </main>
  );
